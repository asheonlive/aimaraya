...
MODELS: list[dict[str, Any]] = [
    ...
    {"id": "nano-banana", "name": "Nano Banana", "type": "image",
     ...
     "tagline": "Fast Google Gemini image generation",
     "engine_type": "comfy", "node_class": "GeminiImageNode",
     "base_inputs": {"model": "gemini-2.5-flash-image", "seed": 0,
                     "aspect_ratio": "auto", "response_modalities": "IMAGE"}},
    {"id": "nano-banana-2", "name": "Nano Banana 2", "type": "image",
     "category": "Fast", "credits": 3, "available": True,
     "tagline": "Recommended Google Gemini image model",
     "engine_type": "comfy", "node_class": "GeminiNanoBanana2",
     "base_inputs": {"model": "Nano Banana 2 (Gemini 3.1 Flash Image)", "seed": 0,
    ...
    {"id": "nano-banana-pro", "name": "Nano Banana Pro", "type": "image",
     ...
     "tagline": "Premium Google Gemini image quality",
     "engine_type": "comfy", "node_class": "GeminiImage2Node",
     "base_inputs": {"model": "gemini-3-pro-image-preview", "seed": 0,
                     "aspect_ratio": "auto", "resolution": "1K",
