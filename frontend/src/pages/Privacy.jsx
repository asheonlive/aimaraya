...
const SECTIONS = [
  { h: "1. Information We Collect", b: "When you create an account, we store your email, an encrypted password, credit balance, and generation metadata needed to operate the service." },
  { h: "2. How We Use Information", b: "To operate the service, deliver generations, process payments, provide support, and improve the platform. We never sell your data to third parties." },
  { h: "3. Third-Party Processors", b: "We use Stripe for payment processing, model providers for AI generation, and industry-standard cloud infrastructure. Each processes data only to deliver the AI MARAYA service." },
  ...
  { h: "7. Security", b: "We use TLS in transit, hashed passwords, and short-lived login sessions. Keep your password private and unique to this service." },
